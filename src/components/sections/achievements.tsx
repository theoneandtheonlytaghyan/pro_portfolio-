      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Highlighting impactful projects, internships, and contributions in AI and machine learning.
          </p>
        </motion.div>
        ...
        >
          <div className="p-6 rounded-lg bg-primary/5 border border-primary/20">
            ...
            <p className="text-sm text-muted-foreground">AI Projects Completed</p>
          </div>
          <div className="p-6 rounded-lg bg-primary/5 border border-primary/20">
            <TrendingUp className="h-8 w-8 text-primary mx-auto mb-2" />
            <p className="text-3xl font-bold gradient-text">5+</p>
            <p className="text-sm text-muted-foreground">Kaggle Contributions</p>
          </div>
          <div className="p-6 rounded-lg bg-primary/5 border border-primary/20">
            <Award className="h-8 w-8 text-primary mx-auto mb-2" />
            <p className="text-3xl font-bold gradient-text">1</p>
            <p className="text-sm text-muted-foreground">Graduation Project with Honors</p>
          </div>
        </motion.div>
      </div>
    </section>
